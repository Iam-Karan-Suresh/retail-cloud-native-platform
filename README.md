...
- [Cleanup](https://github.com/iam-Karan-Suresh/retail-store-with-deployments/blob/main/README.md#step-12-cleanup)
...
3. **Clone Repository**: `git clone https://github.com/iam-Karan-Suresh/retail-store-with-deployments.git`
...
```sh
git clone https://github.com/iam-Karan-Suresh/retail-store-with-deployments.git
```
